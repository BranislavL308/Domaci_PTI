...
while True:
    ...
    for n in neighbours:
        ...
        if v[n] >= new_value:
            # ako je predhodna vrednost bolja, preskoci
            continue
        else:
            # ako je nova vrijednost bolja, proveri je
            v[n] = new_value
...
# %%
# Funkciji  shortetst_path(start_node, end_node) se prosledjuju
# pocetni i krajnji cvor, izlaz funkcije je lista koja predstavlja
# najkracu putanju od pocetnog do krajnjeg cvora
